const C='gengrail-log-v24.10.0-selectable-stream';
...
self.addEventListener('fetch',e=>{
 ...
 const forceReload=path.endsWith('/grail-pre2002-safety.js')||path.endsWith('/grail-visual-gate.js')||path.endsWith('/grail-selectable-stream-v1.js')||path.endsWith('/grail-hub.css')||path.endsWith('/profit-engine-diagnostic.js')||path.endsWith('/gengrail-theme.css')||path.endsWith('/index.html')||path.endsWith('/temporary-test-repo/');
