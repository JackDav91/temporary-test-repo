const C='gengrail-log-v24.9.6-grail-identity-v1121';
const A=['./','./index.html','./manifest.json','./gengrail-theme.css','./gengrail-ebay.js','./gengrail-profit-engine.js','./profit-engine-diagnostic.js','./home-compact.css','./grail-hub.css','./grail-visual-gate.js','./grail-hub.js','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch',e=>{
 ...
 const forceReload=path.endsWith('/grail-visual-gate.js')||path.endsWith('/grail-hub.css')||path.endsWith('/profit-engine-diagnostic.js')||path.endsWith('/gengrail-theme.css')||path.endsWith('/index.html')||path.endsWith('/temporary-test-repo/');
