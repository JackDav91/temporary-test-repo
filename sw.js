const C='gengrail-log-v21.3.5-isolated-graded-import';
...
async function ebayScriptWithGradedBridge(request){
  ...
  const loader=`\n;(()=>{try{if(!document.querySelector('script[data-gengrail-graded-bridge]')){const s=document.createElement('script');s.src='./graded-integration.js?v=21.3.5';s.dataset.gengrailGradedBridge='1';document.head.appendChild(s)}}catch(e){console.warn('graded bridge loader',e)}})();\n`;
