const C='gengrail-log-v24.11.7-densest-comp-cluster';
  ...
  e.respondWith((async()=>{
   try{
    ...
    selectableBody=selectableBody
      .replace("const PATCH_VERSION='selectable-stream-v1.0.0'","const PATCH_VERSION='selectable-stream-v1.1.7'")
      ...
      .replace('none produced 3+ targeted comps with positive economics.','none produced 2+ targeted comps inside the strongest ±£5 market cluster with positive economics.')
